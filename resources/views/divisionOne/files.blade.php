...
@section('content')
            <div id="layoutSidenav_content">
                <main>
                    ...
                    @if(request('search'))
                        <h1 class="mt-4 float-start">Files | Search results for: {{ request('search') }}</h1>
                    @else
                        <h1 class="mt-4 float-start">Files</h1>
                    @endif
                     <a href="/admin/files/upload" class="mt-4 btn btn-primary btn-lg float-end" tabindex="-1" role="button" aria-disabled="true">Upload</a>
                      ...
                      <table class="table mt-4 table-responsive" id="FilesTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                   <a href="{{$file->secure_path}}" class="btn btn-primary btn-sm" tabindex="-1" role="button" aria-disabled="true"><i class="fa-solid fa-file-pdf" ></i></a>

                                     <button type="button" class="btn btn-secondary btn-sm" id="confirm_delete_product_btn" onclick="ShowConfirmDeleteForm('{{ $file->filename }}','{{ $file->id }}')">

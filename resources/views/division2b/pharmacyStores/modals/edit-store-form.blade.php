<div class="modal" id="editPharmacyStore_modal" tabindex="-1">
        ...
        <div class="modal-body">
          ...
          <div class="card">
              <div class="p-4 card-body">
                  ...
                  <div class="row">
                      <form action="" method="POST" id="#pharmacyStoreUpdateForm">
                          ...
                          <div class="p-4 border rounded border-3">
                              <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" name="address" id="eaddress" rows="3" required></textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="ecover_image" class="imageuploadify-file-general-class" name="ecover_image" type="file" accept=".xlsx,.xls,image/*,.doc,audio/*,.docx,video/*,.ppt,.pptx,.txt,.pdf">
                                </div>
                              </div>
                          </div>
                      </div>
      ...
      function updateForm(){
        ...
        if(flag === true) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "/admin/divisiontwob/pharmacy_store/update_store",
                data: formData,
                contentType: false,
                processData: false,
                dataType: "json",
                ...
                $('#editPharmacyStore_modal').modal('hide');
                },error: function(msg) {

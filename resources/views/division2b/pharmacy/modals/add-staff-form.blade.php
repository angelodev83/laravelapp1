<div class="modal" id="addPharmacyStaff_modal" tabindex="-1">
        ...
        <div class="modal-body">
          ...
          <div class="card">
              <div class="p-4 card-body">
                  <h6 class="card-title">Add New Staff</h6>
                  <hr/>
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-12">
                          <div class="p-4 border rounded border-3">
                              <div class="row g-3">
                                <div class="col-md-12">
                                    <input type="hidden" id="pharmacy_store_id" name="id" value="">
  ...
  <script>
      ...
      function saveForm(){
          ...
          $('#addPharmacyStaff_modal input, #addPharmacyStaff_modal textarea, #addPharmacyStaff_modal select').each(function() {
          ...
          if(flag === true) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "/admin/divisiontwob/pharmacy_staff/add_staff",
                ...
                success: function(data) {
                    ...
                    if(data.status == 'success') {
                        $("input#pharmacy_store_id").val(data.data.pharmacy_store_id);
                        
                        table_staff.ajax.reload(null, false);
                    }
                    
                    sweetAlert2(data.status, data.message);
                    $('#addPharmacyStaff_modal').modal('hide');

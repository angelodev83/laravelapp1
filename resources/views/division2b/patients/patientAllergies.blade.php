...
<div class="page-wrapper">
    ...
    @include('division2b/patients/modalAllergies/add-form')
    @include('division2b/patients/modalAllergies/delete-form')
    @include('division2b/patients/modalAllergies/edit-form')
</div>
<!--end page wrapper -->
@stop
...
<script>
    ...
    $(document).ready(function(){
        ...
        table_allergies.buttons().container().appendTo( '.dt-card-header' );

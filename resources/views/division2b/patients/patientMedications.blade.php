...
<div class="page-wrapper">
    ...
    @include('division2b/patients/modalMedications/add-form')
    @include('division2b/patients/modalMedications/delete-form')
    @include('division2b/patients/modalMedications/edit-form')
</div>
<!--end page wrapper -->
@stop
...
<script>
    ...
    $(document).ready(function(){
        ...
        table_medications.buttons().container().appendTo( '.dt-card-header' );

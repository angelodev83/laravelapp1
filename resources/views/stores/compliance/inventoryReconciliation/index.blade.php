...
<!--start page wrapper -->
        ...
        @include('stores/compliance/inventoryReconciliation/modals/delete')
@stop
...
<script>
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            dom: 'fBtip',
            buttons: [
                @can('menu_store.cnr.inventory_reconciliation.create')
                {
            ...
            destroy: true,
            ajax: {
                url: "/store/compliance/inventory-reconciliation/data",
                type: "POST",
                headers: {
    ...
    $('#upload_documents').change(function () {
        if(this.files.length){
            ...
            $.ajax({
                ...
                type: "POST",
                url: `/store/compliance/${menu_store_id}/inventory-reconciliation/add`,
                data: formData,
                contentType: false,
                processData: false,
                dataType: "json",

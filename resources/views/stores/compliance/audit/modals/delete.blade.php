<div class="modal modal-md" style="display:none;" id="delete_document_form_modal" tabindex="-1">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              <form name="delete_form"  id="delete_form"  >
                    <p>You are about to remove a Audit record from document. This procedure is irreversible. </p>
  ...
  <script>
      function clickDeleteBtn(id) {
          ...
          $('#title_document_id_text').html('Audit: '+id);
      }
      ...
      function saveDelete() {
          ...
          $.ajax({
              ...
              type: "POST",
              url: "/store/compliance/audit/delete",

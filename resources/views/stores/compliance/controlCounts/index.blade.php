...
<!--start page wrapper -->
		<div class="page-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-3">
                        @include('stores/compliance/controlCounts/partials/menu')
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <select class="form-select fw-bold" onchange="javascript: window.location.href = `/store/inventory-reconciliation/{{request()->id}}/monthly-control-counts/${this.value}/{{request()->month_number}}`;">
                                    ...
                                    <div class="col-12 col-lg-12">
                                        @include('stores/compliance/controlCounts/partials/folders')
                                    </div>
                                </div>
                                <div class="row ms-2 me-3">
                                    <div class="col-12 col-lg-12">
                                        @include('stores/compliance/controlCounts/partials/table')
                                    </div>
                                </div>
            ...
            @include('stores/compliance/controlCounts/modals/delete')
            @include('stores/compliance/controlCounts/modals/add')
            @include('stores/compliance/controlCounts/modals/edit-folder')
...
<script>
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "/store/inventory-reconciliation/monthly-control-counts/data",
                type: "POST",
                headers: {
            ...
            columns: [
                ...
                { data: 'subtext', name: 'subtext', title: 'Group', searchable: false},

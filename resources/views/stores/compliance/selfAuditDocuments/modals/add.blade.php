<div class="modal" id="add_modal" tabindex="-1">
                          ...
                          <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control datepicker" id="month_year" name="month_year" value="{{request()->year.'-'.sprintf("%02d", request()->month_number)}}" placeholder="YYYY-MM">
                              ...
                              <div class="col-md-12" id="for-new-folder" hidden>
  ...
  <script>
    function clickUploadBtn() {
        ...
        let month = {{request()->month_number}};
        ...
        $(`#add_modal #month_year`).val(year+'-'+month);
    ...
    function saveForm(){
        ...
        data['tag_type'] = 'monthly_control_counts';
        ...
        $.ajax({
            ...
            type: "POST",
            url: `/store/inventory-reconciliation/${menu_store_id}/monthly-control-counts/add`,
            data: formData,
            contentType: false,
            processData: false,
            success: function(data) {
                ...
                if(data.errors){
                    ...
                    let string = reloadPageWithParams(additionalParams, true);

                    window.location.href = `/store/compliance/${menu_store_id}/self-audit-documents/${$year}/${data.data.month}?folder_id=${data.data.folder_id}`;

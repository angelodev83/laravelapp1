      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              <form name="delete_form"  id="delete_form"  >
                    <p>You are about to remove a Compliance & Regulatory > Control Counts document record. This procedure is irreversible. </p>
  ...
  <script>
      ...
      function saveDelete() {
          ...
          $.ajax({
              ...
              type: "DELETE",
              url: `/store/inventory-reconciliation/${menu_store_id}/monthly-control-counts/delete`,

...
<!--start page wrapper -->
        ...
        @include('stores/compliance/selfAuditDocuments/monthlySelfAssessmentQa/modals/add')
@stop
...
<script>
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "/store/compliance/self-audit-documents/monthly-self-assessment-qa/data",
                type: "POST",
                headers: {
    ...
    //             type: "POST",
    //             url: `/store/compliance/self-audit-documents/monthly-self-assessment-qa/add`,
    //             data: formData,
    //             contentType: false,
    //             processData: false,
    //             dataType: "json",

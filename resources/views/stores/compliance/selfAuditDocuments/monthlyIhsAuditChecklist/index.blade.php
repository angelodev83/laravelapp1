...
<!--start page wrapper -->
        ...
        @include('stores/compliance/selfAuditDocuments/monthlyIhsAuditChecklist/modals/delete')
        @include('stores/compliance/selfAuditDocuments/monthlyIhsAuditChecklist/modals/add')
@stop
...
<script>
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "/store/compliance/self-audit-documents/monthly-ihs-audit-checklist/data",
                type: "POST",
                headers: {
    ...
    //             type: "POST",
    //             url: `/store/compliance/self-audit-documents/monthly-ihs-audit-checklist/add`,
    //             data: formData,
    //             contentType: false,
    //             processData: false,
    //             dataType: "json",

...
<!--start page wrapper -->
		<div class="page-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-3">
                        @include('stores/compliance/selfAuditDocuments/partials/menu')
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <select class="form-select fw-bold" onchange="javascript: window.location.href = `/store/compliance/{{request()->id}}/self-audit-documents/${this.value}/{{request()->month_number}}`;">
                                    ...
                                    <div class="col-12 col-lg-12">
                                        @include('stores/compliance/selfAuditDocuments/partials/folders')
                                    </div>
                                </div>
                                <div class="row ms-2 me-3">
                                    <div class="col-12 col-lg-12">
                                        @include('stores/compliance/selfAuditDocuments/partials/table')
                                    </div>
                                </div>
            ...
            @include('stores/compliance/selfAuditDocuments/modals/delete')
            @include('stores/compliance/selfAuditDocuments/modals/add')
            @include('stores/compliance/selfAuditDocuments/modals/edit-folder')
...
<script>
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "/store/compliance/self-audit-documents/data",
                type: "POST",
                headers: {

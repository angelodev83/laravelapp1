...
<!--start page wrapper -->
		<div class="page-wrapper">
			...
			@include('stores/dataInsights/grossSales/modal/edit-form')
			@include('stores/dataInsights/grossSales/modal/delete-form')
...
<script>
    ...
    function loadData() 
    {
        ...
        const cp_table = $('#table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "/store/data-insights/gross-sales/data",
                type: "Get",
                headers: {
            ...
            columns: [
                ...
                { data: 'rx_number', name: 'rx_number', title: 'Rx No. - Refill#', 
                    render: function(data, type, row) {
                    return `${row.rx_number}-${row.refill_number}`;
                } },
                { data: 'transaction_date', name: 'transaction_date', title: 'Transaction Date'},
                { data: 'date_filled', name: 'date_filled', title: 'Date Filled'},
    ...
    {
        proceedImportSingleExcel('gross-sales/import');
    }

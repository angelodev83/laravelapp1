    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form name="delete_form"  id="delete_form"  >
                  <p>You are about to delete a Collected Payments record. This procedure is irreversible. </p>
                  <p id="title_id_text" class="fw-bold"><p>
                  <input id="id" type="hidden" />
                  <p>This will delete the following:</p>
                  <ul>
                      <li>Collected Payments Record</li>
                  </ul>
  ...
  function ShowConfirmDeleteForm(id) {
    ...
    function DeleteOrder() {
        ...
        $.ajax({
            ...
            type: "DELETE",
            url: "/store/data-insights/collected-payments/delete",

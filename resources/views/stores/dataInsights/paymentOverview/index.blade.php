...
<!--start page wrapper -->
		<div class="page-wrapper">
            ...
            @include('stores/dataInsights/paymentOverview/modal/add-payment-form')
            @include('stores/dataInsights/paymentOverview/modal/edit-payment-form')
            @include('stores/dataInsights/paymentOverview/modal/delete-payment-form')
		</div>
		<!--end page wrapper -->
@stop
...
<script>
    ...
    function showAddNewForm(){
        ...
        $.ajax({
            ...
            type: "GET",
            url: `/store/data-insights/${menu_store_id}/payments-overview/get_statuses`,
    ...
    $(document).ready(function() {
        ...
        let payment_table = $('#payment_table').DataTable({
            ...
            ajax: {
                url: `/store/data-insights/${menu_store_id}/payments-overview/data`,
                type: "GET",
                headers: {

...
<!--start page wrapper -->
		<div class="page-wrapper">
            ...
            <div class="row">
                <div class="col-12 col-lg-3">
                    @include('stores/patientPrescriptionTransfers/partials/menu')
                </div>
                ...
                <div class="col-12 col-lg-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @include('stores/patientPrescriptionTransfers/partials/table')
        ...
        @include('stores/patientPrescriptionTransfers/modals/import')
@stop
...
let table_patients;
    ...
    function loadPatients()
    {
        const patients_table = $('#dt_table').DataTable({
            ...
            searching: true,
            ajax: {
                url: "/store/jot-form/patient-prescription-transfers/data",
                type: "POST",
                headers: {
		...
		$('#dt_table').on('click', 'tr', function() {
			...
			console.log(id);
			window.location.href = `/store/jot-form/${menu_store_id}/patient-prescription-transfers/facesheet/${id}`;
		});

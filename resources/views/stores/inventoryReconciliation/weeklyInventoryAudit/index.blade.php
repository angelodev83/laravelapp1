...
<!--start page wrapper -->
        ...
        @include('stores/inventoryReconciliation/weeklyInventoryAudit/modals/delete')
        @include('stores/inventoryReconciliation/weeklyInventoryAudit/modals/add')
@stop
...
<script>
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "/store/inventory-reconciliation/weekly-inventory-audit/data",
                type: "POST",
                headers: {
            ...
            columns: [
                ...
                { data: 'task_week', name: 'task_week', title: 'Task Week', searchable: false, orderable: false},

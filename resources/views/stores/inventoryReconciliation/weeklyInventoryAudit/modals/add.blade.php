                ...
                <div class="row">
                    <form action="" method="POST" id="#add_form">
                        <div class="col-lg-12">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label for="month" class="form-label">Week Covered <span class="text-danger">*</span></label>
  ...
  <script>
    ...
    function saveForm(data)
    {
        ...
        $.ajax({
            ...
            type: "POST",
            url: `/store/inventory-reconciliation/weekly-inventory-audit/add`,
            data: formData,
            contentType: false,
            processData: false,
            dataType: "json",

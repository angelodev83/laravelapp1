...
<!--start page wrapper -->
        ...
        @include('stores/inventoryReconciliation/dailyInventoryEvaluation/modals/delete')
        @include('stores/inventoryReconciliation/dailyInventoryEvaluation/modals/add')
@stop
...
<script>
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "/store/inventory-reconciliation/daily-inventory-evaluation/data",
                type: "POST",
                headers: {
            ...
            columns: [
                ...
                { data: 'task_date', name: 'task_date', title: 'Task Day', searchable: false, orderable: false},

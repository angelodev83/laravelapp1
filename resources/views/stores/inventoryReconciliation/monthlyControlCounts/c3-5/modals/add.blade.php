                ...
                <div class="row">
                    <form action="" method="POST" id="#add_form">
                        <div class="col-lg-12">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label for="month" class="form-label">Month Covered <span class="text-danger">*</span></label>
                                    <div class="input-group"> <span class="input-group-text" id="icon-order-date"><i class="fa fa-calendar"></i></span>
                                        <input type="text" name="month" class="form-control" id="month" placeholder="YYYY-MM" required>
                                    </div>
                                </div>
  ...
  <script>
    ...
    function saveForm(data)
    {
        ...
        $.ajax({
            ...
            type: "POST",
            url: `/store/inventory-reconciliation/monthly-control-counts/c2/add`,
            data: formData,
            contentType: false,
            processData: false,
            dataType: "json",

      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              <form name="delete_form"  id="delete_form"  >
                    <p>You are about to remove a Monthly > Control Counts C2 Document from record. This procedure is irreversible. </p>
                    <p id="title_document_id_text" class="fw-bold"><p>
                    <input id="reload" value="false" type="hidden" />
                    <input id="id" type="hidden" />
                    <p>This will delete the following:</p>
                    <ul>
                        <li>Inventory Reconcilication: Monthly > Control Counts C2 Document</li>
                    </ul>
  ...
  <script>
      ...
      function saveDelete() {
          ...
          $.ajax({
              ...
              type: "DELETE",
              url: "/store/inventory-reconciliation/monthly-control-counts/c2/delete",

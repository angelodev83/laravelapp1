...
<!--start page wrapper -->
        ...
        @include('stores/inventoryReconciliation/monthlyControlCounts/c3-5/modals/delete')
        @include('stores/inventoryReconciliation/monthlyControlCounts/c3-5/modals/add')
@stop
...
<script>
    ...
    let nav_code = 'ir_monthly_c3_5';

    $(document).ready(function() {
        menu_store_id = {{request()->id}};
        nav_code = 'ir_monthly_c3_5';
        loadDocuments();
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "/store/inventory-reconciliation/monthly-control-counts/c3-5/data",
                type: "POST",
                headers: {

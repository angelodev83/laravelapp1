        ...
        <div class="row gy-1">
            ...
            <div class="col-12 mb-0 pb-0">
                <div class="drop-area" id="dropArea">
                    ...
                    <div for="fileInput" class="btn btn-outline-primary w-100" style="border-radius: 100px;" id="upload_button" onclick="clickTaskUploadBtn()">or select files to upload</div>
                </div>
            ...
            <div class="col-12 mt-2" >
                ...
                <div class="store-metrics pe-0 mb-1 pb-1" id="taskAttachmentsList"></div>

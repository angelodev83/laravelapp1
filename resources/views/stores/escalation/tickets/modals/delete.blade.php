<div class="modal modal-md" style="display:none;" id="delete_ticket_form_modal" tabindex="-1">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              <form name="delete_form"  id="delete_form"  >
                    <p>You are about to remove a Ticket record. This procedure is irreversible. </p>
                    <p id="title_ticket_id_text" class="fw-bold"><p>
  ...
  <script>
      function clickDeleteBtn(id) {
          $('#delete_ticket_form_modal').modal('show');
          $('#delete_ticket_form_modal #id').val(id);
          $('#title_ticket_id_text').html('Ticket: '+id);
      }
      ...
      function saveDelete() {
          var data = {};
            ...
            data.id = $('#delete_ticket_form_modal #id').val();
          ...
          $.ajax({
              ...
              type: "POST",
              url: "/store/escalation/tickets/delete",
              ...
              //success
                  ...
                  $('#delete_ticket_form_modal').modal('toggle');

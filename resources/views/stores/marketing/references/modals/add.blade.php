<div class="modal" id="add_modal" tabindex="-1">
                  ...
                  <form action="" method="POST" id="#addForm">
                    ...
                    <input type="text" name="page_code" class="form-control" id="page_code" hidden>
                      <div class="col-lg-12">
                          <div class="row g-3">
                              <div class="col-md-6">
                                  <label for="folder" class="form-label">Folders <span class="text-red">*</span></label>
                            ...
                            <div class="col-md-12 d-none" id="for-new-folder">
                                <label for="new_folder" class="form-label">New Folder Name <span class="text-red">*</span></label>
                                <input type="text" name="new_folder" class="form-control" id="new_folder" placeholder="Enter Folder Name" required>
                                <div class="invalid-feedback">
                                Folder name is required</div>
                            </div>

                            <div class="col-md-6">
                                <label for="score" class="form-label">Score <span class="text-red">*</span></label>
                                <input type="number" name="score" class="form-control text-end" id="score" placeholder="eg. 5" required>
                                <div class="invalid-feedback">
                                Score is required</div>
                            </div>
  ...
  <script>
    function clickUploadBtn() {
        ...
        if(!folder_id) {
            const default_first = {{$folders[0]->id}}
            $('#add_modal #folder_id').val(default_first)
        ...
        $('#add_modal .imageuploadify-message').html('Drag&Drop Your Image Here To Upload');     
    ...
    function saveForm(){
        ...
        if ($('#add_modal #score').val() == '') {
            if(!$(`#add_modal #score`)[0].checkValidity()) {
                $(`#add_modal #score`).addClass("is-invalid");
                return;
            }
        }
        ...
        data['menu_page'] = 'marketing';
        data['default_file_bg'] = '#c0e7e8';

...
<!--start page wrapper -->
		<div class="page-wrapper">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-9">
                                ...
                                @include('stores/marketing/decks/partials/folders')
                            </div>
                            <div class="col-12 col-lg-3">
                                ...
                                @endif
                                @endcanany
                                @include('stores/marketing/decks/partials/recent-upload-files')
                            </div>
                        </div>
                        <div class="row ms-2 me-3">
                            <div class="col-12 col-lg-12">
                                @include('stores/marketing/decks/partials/table')
                            </div>
                        </div>
            ...
            @include('stores/marketing/decks/modals/delete')
            @include('stores/marketing/decks/modals/add')
            @include('stores/marketing/decks/modals/edit-folder')
...
<script>
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "/store/marketing/decks/data",
                type: "POST",
                headers: {
                ...
                data: function (data) {
                    ...
                    // data.parent_page_id = 78;
                    data.page_id = page_id;
                    data.page_code = 'decks';
                    if(folder_id) {

    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form name="delete_form"  id="delete_form"  >
                  <p>You are about to delete a EOD Deposit record. This procedure is irreversible. </p>
                  <p id="title_id_text" class="fw-bold"><p>
                  <input id="id" type="hidden" />
                  <p>This will delete the following:</p>
                  <ul>
                      <li>EOD Deposit Record</li>
                  </ul>
...
<script>
  function ShowConfirmDeleteForm(id) {
        ...
        $('#delete_form_modal #title_id_text').html('EOD Deposit: '+id);
  }
    ...
    function DeleteOrder() {
        ...
        $.ajax({
            ...
            type: "DELETE",
            url: "/store/eod-register-report/deposit/delete",

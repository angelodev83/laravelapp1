    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form name="delete_form"  id="delete_form"  >
                  <p>You are about to delete a EOD Register record. This procedure is irreversible. </p>
                  <p id="title_id_text" class="fw-bold"><p>
                  <input id="id" type="hidden" />
                  <p>This will delete the following:</p>
                  <ul>
                      <li>EOD Register Record</li>
                      <li>File Record</li>
                  </ul>
...
<script>
  function ShowConfirmDeleteForm(id) {
        ...
        $('#delete_form_modal #title_id_text').html('EOD Register: '+id);
  }
    ...
    function DeleteOrder() {
        ...
        $.ajax({
            ...
            type: "DELETE",
            url: "/store/eod-register-report/register/delete",

...
<!--start page wrapper -->
		<div class="page-wrapper">
            ...
            <div class="row">
                <div class="col-12 col-lg-3">
                    @include('stores/patientIntakes/partials/menu')
                </div>
                ...
                <div class="col-12 col-lg-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @include('stores/patientIntakes/partials/table')
        ...
        @include('stores/patientIntakes/modals/import')
@stop
...
let table_patients;
    ...
    function loadPatients()
    {
        const patients_table = $('#dt_table').DataTable({
            ...
            searching: true,
            ajax: {
                url: "/store/jot-form/patient-intakes/data",
                type: "POST",
                headers: {
			...
			columns: [
				...
				{ data: 'firstname', name: 'firstname', title: 'First', visible: true,
					render: function(data, type, row) {
						return '<b>' + data + '</b>';
					}
				},
                { data: 'middlename', name: 'middlename', title: 'Middle', visible: true,
					render: function(data, type, row) {
						return '<b>' + data + '</b>';
					}
				},
				{ data: 'lastname', name: 'lastname', title: 'Last', visible: true,
					render: function(data, type, row) {
						return '<b>' + data + '</b>';
					}
				},
                { data: 'suffix', name: 'suffix', title: 'Suffix', visible: true,
					render: function(data, type, row) {
						return '<b>' + data + '</b>';
					}
				},
		...
		$('#dt_table').on('click', 'tr', function() {
			...
			console.log(id);
			window.location.href = `/store/jot-form/${menu_store_id}/patient-intakes/facesheet/${id}`;
		});

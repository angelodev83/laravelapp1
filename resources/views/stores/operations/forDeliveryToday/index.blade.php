...
<!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="card">
                    <div class="card-header card-index-header">
                        ...
                        <div class="input-group table_length_change me-2" style="min-width: 220px"> 
                            <span class="input-group-text" id="icon-shipped-date">
                                <i class="fa fa-calendar"></i>
                            </span>
                            <input type="text" class="form-control datepicker" id="delivered_date" placeholder="YYYY-MM-DD">
                            <span class="input-group-text clear-shipped-date" id="icon-shipped-date" onclick="clearShippedDateFilter()">
                                <small>Clear</small>
                            </span>
                        </div>
                        <!-- <div class="input-group me-2" style="min-width: 50px; margin-left: -2px; padding-left:21px">
                            <button class="btn btn-info2 btn-sm" id="get_selected_ids">Complete</button>
                        </div> -->
            ...
            {{-- @include('stores/operations/forDeliveryToday/modals/add') --}}
			@include('stores/operations/forDeliveryToday/modals/delete')
			@include('stores/operations/forDeliveryToday/modals/edit')
			@include('stores/operations/forDeliveryToday/modals/bulk-upload')
...
<script>
    ...
    $(document).ready(function() {
        ...
        // $('#delivered_date').val(current_date);
        loadData();
    });
    ...
    function loadData() 
    {
        ...
        const staff_table = $('#dt_operation_order_items_table').DataTable({
            ...
            buttons: [
                ...
                // },
                {
                    text: '<i class="fa-solid fa-square-check me-2"></i>Mark as Delivered', 
                    className: 'btn btn-success btn-sm', 
                    action: function ( e, dt, node, config ) {
                        completed();
                    }
            ...
            destroy: true,
            ajax: {
                url: "/store/operations/for-delivery-today/data",
                type: "POST",
                headers: {
                ...
                data: function (data) {
                    ...
                    data.delivered_date = $('#delivered_date').val();
                },
                error: function (msg) {
            ...
            columns: [
                ...
                // }},
                { data: 'labeled_date', name: 'labeled_date', title: 'Labeled Date' },
                { data: 'delivered_date', name: 'delivered_date', title: 'Delivered Date' },
                { 
                    data: 'status', 
                    name: 'status', 
                    title: 'Status',
                    ...
                    render: function(data, type, row) {
                        if (data === 1) {
                            return '<button type="button" class="btn btn-success btn-sm w-100"><small>Delivered</small></button>';
                        } else if (data === 0) {
                            return '';  
                        } else {
                            return ''; 
                ...
                { data: 'shipping_label', name: 'shipping_label', title: 'Delivery Label' },
		...
		$('#delivered_date').change(function(){ table_operation_order.draw()})
    ...
    function completed(){
        ...
        $.ajax({
            ...
            type: "POST",
            url: `/store/operations/for-delivery-today/update-completed`,
    ...
    {
        proceedImportSingleExcel('/store/operations/for-delivery-today/upload');
    }
    ...
    function showDeleteFileOnly(){
        ...
        $.ajax({
            ...
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "DELETE",
            url: `/store/operations/for-delivery-today/upload/shipping-label/delete`,
            data: JSON.stringify(data),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function(data) {

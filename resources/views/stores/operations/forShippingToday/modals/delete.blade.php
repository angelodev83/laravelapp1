      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              <form name="delete_form"  id="delete_form"  >
                    <p>You are about to delete a For Shipping Today record. This procedure is irreversible. </p>
                    <p id="order_id_text" class="fw-bold"><p>
                    <input id="item_id" type="hidden" />
                    <p>This will delete the following:</p>
                    <ul>
                        <li>For Shipping Today Record</li>
                        <li>Any associated shipping label file uploaded to this shipping</li>
                    </ul>
  ...
  <script>
    ...
    function DeleteOrder() {
          ...
          $.ajax({
              ...
              type: "POST",
              url: `/store/operations/for-shipping-today/delete`,

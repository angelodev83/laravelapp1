...
<!--start page wrapper -->
		<div class="page-wrapper">
			...
			@include('stores/operations/monthlyRevenue/modal/add-monthlyrevenue-form')
    		@include('stores/operations/monthlyRevenue/modal/edit-monthlyrevenue-form')
    		@include('stores/operations/monthlyRevenue/modal/delete-monthlyrevenue-form')
		</div>
		<!--end page wrapper -->
@stop
...
<script>
    ...
    function showAddNewForm(){
        ...
        $.ajax({
            ...
            type: "GET",
            url: `/store/operations/${menu_store_id}/pgr/get_store_data`,
    ...
    $(document).ready(function() {
        ...
        let monthlyRevenue_table = $('#monthlyRevenue_table').DataTable({
            ...
            ajax: {
                url: `/store/operations/${menu_store_id}/pgr/data`,
                type: "GET",
                headers: {

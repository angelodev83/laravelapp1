      ...
      <div class="modal-body">
            <form name="delete_form"  id="delete_form"  >
                  ...
                  <ul>
                      ...
                      <li>Any associated orders with the Patient</li>
                  </ul>
...
<script>
  function ShowConfirmDeleteForm(id,name) {
        $('#delete_form_modal').modal('show');
        $('#delete_form_modal #patient_id').val(id);
        $('#order_id_text').html('Patient: '+name);
  }
  ...
  function DeletePatient(id) {
                ...
                data.patient_id = $('#delete_form_modal #patient_id').val();

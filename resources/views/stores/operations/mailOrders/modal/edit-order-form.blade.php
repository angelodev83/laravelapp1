                                                 ...
                                                 <div class="row">
                                                         <div class="col-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input id="patient_name" disabled class="form-control mb-2" name="patient_name" type="text"  />
...
<script>
    function showDeleteFileOnly(){
        ShowConfirmDeleteForm($("#edit_order_modal #order_id").val(), $("#edit_order_modal #file_id").val(),1);
    }

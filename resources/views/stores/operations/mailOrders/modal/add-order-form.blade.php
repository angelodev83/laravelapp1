                                                 ...
                                                 <div class="row">
                                                        <div class="col">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="order_number" maxlength="50" pattern="\d{1,8}">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered" id="medication_table">
                                                                        ...
                                                                        <tbody id="medications_table">
                                                                            <input type="hidden" id="med_count">
                                                                            @for ($i = 0; $i < 2; $i++)
                                                                                <tr>
                                                                                    <td>
                                                                                        <select class="form-select" data-placeholder="Select medication.." name="items[{{$i}}][med_id]" id="medi_id{{$i}}" onchange="mirrorSelectToInput(this.id)"></select>

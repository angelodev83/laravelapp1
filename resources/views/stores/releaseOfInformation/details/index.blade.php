...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="row g-3">
            <div class="col-lg-12">
                @include('stores/releaseOfInformation/details/partials/personal')
            </div>
            <div class="col-lg-7">
                {{-- @include('stores/releaseOfInformation/details/partials/sms') --}}
            </div>
        </div>
    </div>
...
<script>
    ...
    let phone_number = {!! json_encode(htmlspecialchars_decode($details['phone_number'])) !!};
    let patient_id = {!! json_encode(htmlspecialchars_decode($details['tebra_id'])) !!};
    ...
    let p_id = {!! json_encode(htmlspecialchars_decode($details['id'])) !!};
    let userId = {{$user->id}};

    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form name="delete_form"  id="delete_form"  >
                  <p>You are about to delete a Clinical Therapy change+reco record. This procedure is irreversible. </p>
...
<script>
  function ShowConfirmDeleteForm(id) {
        ...
        $('#delete_form_modal #title_id_text').html('Clinical Therapy change+reco: '+id);
  }
    ...
    function doDelete() {
        ...
        $.ajax({
            ...
            type: "DELETE",
            url: "/store/clinical/therapy-change-and-reco/delete",

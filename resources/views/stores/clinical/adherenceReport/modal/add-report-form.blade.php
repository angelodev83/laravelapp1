...
<script>
  ...
  //console.log(data);
    $.ajax({
      ...
      type: "POST",
      url: "/store/clinical/adherence-reports/add",
      ...
      success: function(msg) {
        ...
        if (msg.errors) {
          ...
          const yr = $('#report_year').val();
          const menu_store_id = {{request()->id}}
                window.location.href = `/store/clinical/${menu_store_id}/adherence-reports/${yr}`
            }
      },
      error: function(msg) {

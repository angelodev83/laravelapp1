...
<!--start page wrapper -->
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-12">
                    ...
                    @include('stores/clinical/bridgedPatients/partials/summary')
                </div>
                    ...
                    <div class="card">
                        <div class="card-header dt-card-header">
                            ...
                            <div class="row mx-2">
                                ...
                                <div class="col-9">
                                    @can('menu_store.clinical.bridged_patients.create')
                                    ...
                                    @can('menu_store.clinical.bridged_patients.delete')
        ...
        @include('stores/clinical/bridgedPatients/modal/add')
        @include('stores/clinical/bridgedPatients/modal/edit')
        @include('stores/clinical/bridgedPatients/modal/delete')
        @include('stores/clinical/bridgedPatients/modal/delete-all')
...
<script>
    ...
    let selectedDate = '';
    let $_CALENDAR_URL = '/store/clinical/'+{{request()->id}}+'/bridged-patients/date-with';
    let selectedIds = {};  
    ...
    $(document).ready(function() {
        ...
        const table = $('#table').DataTable({
            ...
            searching: true,
            ajax: {
                url: `/store/clinical/bridged-patients/data`,
                type: "GET",
                headers: {
    ...
    function clickExportBtn() {
        ...
        let url = `bridged-patients/export`;
    ...
    function saveImportSingleExcel()
    {
        ...
        proceedImportSingleExcel('/store/clinical/'+menu_store_id+'/bridged-patients/import', data);
    }
    ...
    function generateSummary()
    {
        ...
        $.ajax({
            ...
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "POST",
            url: `/store/clinical/bridged-patients/summary`,
    ...
    function clickSendMailBtn()
    {
        ...
        $.ajax({
            ...
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "POST",
            url: `/store/clinical/bridged-patients/send-mail`,
            data: JSON.stringify(data),
            contentType: "application/json; charset=utf-8",
            dataType: 'json',
            success: function(response) {
    ...
    function customizeImportModal()
    {
        ...
        $('#import_single_excel_modal #guide_table').html(`
            <p class="my-1 py-0">
                ** Check file <i>Clinical Import Excel Template - Bridged Patients.xlsx</i> from <a href="/store/knowledge-base/1/process-documents?folder_id=90" target="_blank">Knowledge Base > Process Documents > <u>Templates</u></a>
            </p>

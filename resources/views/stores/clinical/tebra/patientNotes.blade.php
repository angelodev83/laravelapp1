...
<div class="page-wrapper">
    ...
    @include('stores/clinical/tebra/modalNotes/add-form')
    @include('stores/clinical/tebra/modalNotes/edit-form')
    @include('stores/clinical/tebra/modalNotes/delete-form')
</div>
<!--end page wrapper -->
@stop
...
<script>
    ...
    $(document).ready(function(){
        ...
        const notes_table = $('#notes_table').DataTable({
            ...
            searching: true,
            ajax: {
                url: "/store/clinical/tebra-patients/get_patient_notes_data",
                type: "POST",
                headers: {
        ...
        table_notes.buttons().container().appendTo( '.card-header' );

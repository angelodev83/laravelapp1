    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form name="delete_form"  id="delete_form"  >
                  <p>You are about to delete a Patient Immunization record. This procedure is irreversible. </p>
                  <p id="title_id_text" class="fw-bold"><p>
                  <input id="id" type="hidden" />
                  <p>This will delete the following:</p>
                  <ul>
                      <li>Patient Immunization Record</li>
                  </ul>
...
<script>
    ...
    function deleteForm() {
        ...
        $.ajax({
            ...
            type: "POST",
            url: "/store/clinical/tebra-patients/immunization_delete",

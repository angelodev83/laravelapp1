    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form name="delete_form"  id="delete_form"  >
                  <p>You are about to delete a Patient Allergy record. This procedure is irreversible. </p>
                  <p id="title_id_text" class="fw-bold"><p>
                  <input id="id" type="hidden" />
                  <p>This will delete the following:</p>
                  <ul>
                      <li>Patient Allergy Record</li>
                  </ul>
...
<script>
    function ShowConfirmDeleteForm(id) {
        ...
        $('#title_id_text').html('Patient Allergy: '+id);
    }
    ...
    function deleteForm() {
        ...
        $.ajax({
            ...
            type: "POST",
            url: "/store/clinical/tebra-patients/allergy_delete",
            ...
            success: function(msg) {
                ...
                table_allergies.ajax.reload(null, false);
            },error: function(msg) {

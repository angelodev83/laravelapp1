        ...
        <div class="modal-body">      
            <div class="row">
                <form action="" method="POST" id="#editForm">
                    <div class="col-lg-12">
                        <div class="row g-3">
                            <input type="hidden" name="patient_id"  id="allergy_id"> 
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea rows="3" name="description" class="form-control" id="description" placeholder=""></textarea>                                    
                            </div>
                        </div> 
...
<script>
    ...
    function updateForm(){
        ...
        $.ajax({
            ...
            type: "POST",
            url: "/store/clinical/tebra-patients/allergy_update",

...
<div class="page-wrapper">
    ...
    @include('stores/clinical/tebra/modalImmunizations/add-form')
    @include('stores/clinical/tebra/modalImmunizations/edit-form')
    @include('stores/clinical/tebra/modalImmunizations/delete-form')
</div>
<!--end page wrapper -->
@stop
...
<script>
    ...
    $(document).ready(function(){
        ...
        const immunizations_table = $('#immunizations_table').DataTable({
            ...
            searching: true,
            ajax: {
                url: "/store/clinical/tebra-patients/get_patient_immunizations_data",
                type: "POST",
                headers: {
        ...
        table_immunizations.buttons().container().appendTo( '.card-header' );

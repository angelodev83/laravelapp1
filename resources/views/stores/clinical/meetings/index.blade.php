...
<!--start page wrapper -->
		<div class="page-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-3">
                        @include('stores/clinical/meetings/partials/menu')
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-lg-12">
                                        ...
                                        @include('stores/clinical/meetings/partials/folders')
                                    </div>
                                </div>
                                <div class="row ms-2 me-3">
                                    <div class="col-12 col-lg-12">
                                        @include('stores/clinical/meetings/partials/table')
                                    </div>
                                </div>
            ...
            @include('stores/clinical/meetings/modals/delete')
            @include('stores/clinical/meetings/modals/add')
            @include('stores/clinical/meetings/modals/edit-folder')
...
<script>
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "/store/clinical/meetings/data",
                type: "POST",
                headers: {

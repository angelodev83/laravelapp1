    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form name="delete_form"  id="delete_form"  >
                  <p>You are about to delete a Clinical Daily {{request()->status == 'pending' ? 'Pending' : ''}} Rx Transfers record. This procedure is irreversible. </p>
                  <p id="title_id_text" class="fw-bold"><p>
                  <input id="id" type="hidden" />
                  <p>This will delete the following:</p>
                  <ul>
                      <li>Clinical Daily {{request()->status == 'pending' ? 'Pending' : ''}} Rx Transfers Record</li>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" id="delete_btn" onclick="doDelete()">DELETE</button>
      </div>
    </div>
  </div>
</div>
...
<script>
  function ShowConfirmDeleteForm(id) {
        ...
        $('#delete_form_modal #title_id_text').html('Clinical Daily Rx Transfers: '+id);
  }
    ...
    function doDelete() {
        ...
        $.ajax({
            ...
            type: "DELETE",
            url: "/store/clinical/rx-daily-transfers/"+$status+"/delete",

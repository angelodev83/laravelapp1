    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form name="delete_form"  id="delete_form"  >
                  <p>You are about to delete a Clinical Brand Switching IOU record. This procedure is irreversible. </p>
                  <p id="title_id_text" class="fw-bold"><p>
                  <input id="id" type="hidden" />
                  <p>This will delete the following:</p>
                  <ul>
                      <li>Clinical Brand Switching IOU Record</li>
...
<script>
  function ShowConfirmDeleteForm(id) {
        ...
        $('#delete_form_modal #title_id_text').html('Clinical Brand Switching IOU: '+id);
  }
    ...
    function doDelete() {
        ...
        $.ajax({
            ...
            type: "DELETE",
            url: "/store/clinical/brand-switchings/delete",

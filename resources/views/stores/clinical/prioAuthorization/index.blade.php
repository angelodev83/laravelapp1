...
<!--start page wrapper -->
		<div class="page-wrapper">
			<div class="page-content">
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-12 d-none">
                        <div class="card">
							<div class="card-body">
								@include('stores/clinical/prioAuthorization/partials/calendar-html')
							</div>
						</div>
                    </div>
                    ...
                    <div class="col-xl-12 col-md-12">
                        <div class="card">
                            <div class="card-header dt-card-header">
                                ...
                                @can('menu_store.clinical.prio_authorization.create')
                                ...
                                <h6 style="float: left;" class="table_search_input ms-3 d-none">Prio Authorization for: <span id="titleDate"></span></h6>
                            </div>
                            <div class="card-body">
            ...
            @include('stores/clinical/prioAuthorization/modal/selection')
            @include('stores/clinical/prioAuthorization/modal/add')
    		@include('stores/clinical/prioAuthorization/modal/edit')
    		@include('stores/clinical/prioAuthorization/modal/delete')
...
@include('stores/clinical/prioAuthorization/partials/calendar-script')
<script>
    let dt_table;
    let file_table;
    ...
    $(document).ready(function() {
        ...
        const table = $('#table').DataTable({
            ...
            searching: true,
            ajax: {
                url: `/store/clinical/prio-authorization/data`,
                type: "GET",
                headers: {

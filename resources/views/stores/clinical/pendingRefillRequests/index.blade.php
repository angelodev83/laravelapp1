...
<!--start page wrapper -->
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-12">
                    ...
                    @include('stores/clinical/pendingRefillRequests/partials/summary')
                </div>
                    ...
                    <div class="card">
                        <div class="card-header dt-card-header">
                            ...
                            <div class="row mx-2">
                                ...
                                <div class="col-9">
                                    @can('menu_store.clinical.pending_refill_requests.create')
                                    ...
                                    @can('menu_store.clinical.pending_refill_requests.delete')
        ...
        @include('stores/clinical/pendingRefillRequests/modal/add')
        @include('stores/clinical/pendingRefillRequests/modal/edit')
        @include('stores/clinical/pendingRefillRequests/modal/delete')
        @include('stores/clinical/pendingRefillRequests/modal/delete-all')
...
<script>
    ...
    let selectedDate = '';
    let $_CALENDAR_URL = '/store/clinical/'+{{request()->id}}+'/pending-refill-requests/date-with';
    let selectedIds = {};  
    ...
    $(document).ready(function() {
        ...
        const table = $('#table').DataTable({
            ...
            searching: true,
            ajax: {
                url: `/store/clinical/pending-refill-requests/data`,
                type: "GET",
                headers: {
            ...
            columns: [
                ...
                { data: 'medication_description', name: 'medication_description', title: 'Medication'},
                { data: 'provider', name: 'provider', title: 'Provider'},
                { data: 'send_date', name: 'send_date', title: 'Send Date', render: function(data, type, row) {
                    return `${row.formatted_send_date}`;
                } },
                { data: 'status_name', name: 'status_name', title: 'Status'},
                { data: 'remarks', name: 'remarks', title: 'Remarks', render: function(data, type, row) {
                    return `<span title="${row.remarks}">${row.truncated_remarks}</span>`;
                } },
    ...
    function clickExportBtn() {
        ...
        let url = `pending-refill-requests/export`;
    ...
    function saveImportSingleExcel()
    {
        ...
        proceedImportSingleExcel('/store/clinical/'+menu_store_id+'/pending-refill-requests/import', data);
    }
    ...
    function generateSummary()
    {
        ...
        $.ajax({
            ...
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "POST",
            url: `/store/clinical/pending-refill-requests/summary`,
    ...
    function clickSendMailBtn()
    {
        ...
        $.ajax({
            ...
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "POST",
            url: `/store/clinical/pending-refill-requests/send-mail`,
            data: JSON.stringify(data),
            contentType: "application/json; charset=utf-8",
            dataType: 'json',
            success: function(response) {
    ...
    function customizeImportModal()
    {
        ...
        $('#import_single_excel_modal #guide_table').html(`
            <p class="my-1 py-0">
                ** Check file <i>Clinical Import Excel Template - Pending Refill Requests.xlsx</i> from <a href="/store/knowledge-base/1/process-documents?folder_id=90" target="_blank">Knowledge Base > Process Documents > <u>Templates</u></a>
            </p>
            ...
            <div class="table-responsive mb-0 pb-0" style="scrollbar-width: thin;">
                <table class="table table-border" style="width:100%;">
                    ...
                    <tbody>
                        <tr>
                            <td>8/15/2024  8:21:00 AM</td>
                            <td>137010</td>
                            <td>Medication Name 1</td>
                        ...
                        <tr>
                            <td>8/16/2024  9:01:00 AM</td>
                            <td>135681</td>
                            <td>Medication Name 2</td>
                            <td>Doe, John</td>
                            <td>Smith, Will</td>
                            <td>Fax Complete</td>

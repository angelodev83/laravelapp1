...
<!--start page wrapper -->
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-12">
                    ...
                    @include('stores/clinical/rxDailyCensus/partials/summary')
                </div>
                    ...
                    <div class="card">
                        <div class="card-header dt-card-header">
                            ...
                            <div class="row mx-2">
                                ...
                                <div class="col-9">
                                    @can('menu_store.clinical.rx_daily_census.create')
                                    ...
                                    @can('menu_store.clinical.rx_daily_census.delete')
        ...
        @include('stores/clinical/rxDailyCensus/modal/add')
        @include('stores/clinical/rxDailyCensus/modal/edit')
        @include('stores/clinical/rxDailyCensus/modal/delete')
        @include('stores/clinical/rxDailyCensus/modal/delete-all')
...
<script>
    ...
    let selectedDate = '';
    let $_CALENDAR_URL = '/store/clinical/'+{{request()->id}}+'/rx-daily-census/date-with';
    let selectedIds = {};  
    ...
    $(document).ready(function() {
        ...
        const table = $('#table').DataTable({
            ...
            searching: true,
            ajax: {
                url: `/store/clinical/rx-daily-census/data`,
                type: "GET",
                headers: {
            ...
            columns: [
                ...
                { data: 'birth_date', name: 'birth_date', title: 'DOB', orderable: false, render: function(data, type, row) {
                    return `${row.formatted_birth_date}`;
                } },
                { data: 'scripts_received', name: 'scripts_received', title: '# of scripts'},
    ...
    function clickExportBtn() {
        ...
        let url = `rx-daily-census/export`;
    ...
    function saveImportSingleExcel()
    {
        ...
        proceedImportSingleExcel('/store/clinical/'+menu_store_id+'/rx-daily-census/import', data);
    }
    ...
    function generateSummary()
    {
        ...
        $.ajax({
            ...
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "POST",
            url: `/store/clinical/rx-daily-census/summary`,
            ...
            success: function(response) {
                ...
                $('#summary_unique_patient_with_scripts').text(res.summary_unique_patient_with_scripts);

                let topProviderHtml = '';

                let topProviders = res.summary_top_providers;
                for(let x in topProviders) {
                    console.log(topProviders[x]);
                    topProviderHtml += `
                        <tr>
                            <td class="text-center">${topProviders[x].provider}</td>
                            <td class="text-center">${topProviders[x].sum_scripts_received}</td>
                        </tr>
                    `;
                }

                $('#summary_top_providers').html(topProviderHtml);
    ...
    function clickSendMailBtn()
    {
        ...
        $.ajax({
            ...
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            type: "POST",
            url: `/store/clinical/rx-daily-census/send-mail`,
            data: JSON.stringify(data),
            contentType: "application/json; charset=utf-8",
            dataType: 'json',
            success: function(response) {
    ...
    function customizeImportModal()
    {
        ...
        $('#import_single_excel_modal #guide_table').html(`
            <p class="my-1 py-0">
                ** Check file <i>Clinical Import Excel Template - Rx Daily Census.xlsx</i> from <a href="/store/knowledge-base/1/process-documents?folder_id=90" target="_blank">Knowledge Base > Process Documents > <u>Templates</u></a>
            </p>
                ...
                <table class="table table-border" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>07/11/1985</td>
                            <td>0</td>
                            <td>Lastname, Firstname Provider</td>
                            <td>(Optional)</td>
                        </tr>                               
                    </tbody>
                </table>

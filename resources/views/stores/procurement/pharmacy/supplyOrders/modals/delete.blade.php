<div class="modal modal-md" style="display:none;" id="delete_form_modal" tabindex="-1">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              <form name="delete_form"  id="delete_form"  >
                    ...
                    <ul>
                        <li>Order Record</li>
                        <li>Any associated supply item order inside the order</li>
                    </ul>
  ...
  <script>
    function ShowConfirmDeleteForm(id) {
        ...
        $('#delete_form_modal #order_id_text').html('Order ID '+array.id+' Order #: '+array.order_number);
    }
    ...
    function DeleteOrder() {
          ...
          $.ajax({
              ...
              type: "POST",
              url: `/store/procurement/pharmacy/supply-orders/delete`,

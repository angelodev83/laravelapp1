...
<script>
    function showDeleteFileOnly(){
        ...
        $.ajax({
            ...
            type: "DELETE",
            url: `/store/procurement/pharmacy/wholesale-drug-returns/delete_file`,
    ...
    function showUploadForm(id){
        ...
        $('#upload_modal #file').off('change').on('change', function() {
            ...
            $.ajax({
                ...
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                type: "POST",
                url: `/store/procurement/pharmacy/wholesale-drug-returns/file-upload`,
                data: formData,
                contentType: false, 
                processData: false,
                dataType: "json",
        ...
        //let btn = $('#clinicaorder-show-btn-' + id);

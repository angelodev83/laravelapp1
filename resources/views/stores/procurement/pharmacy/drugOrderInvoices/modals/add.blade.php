<div class="modal" id="add_modal" tabindex="-1">
  ...
  <script>
    ...
    function saveForm(){
        ...
        data['menu_page'] = 'drug_order_invoice';
        data['default_file_bg'] = '#c8f4d2';
        ...
        data['default_folder_bg'] = '#c8f4d2';
        data['default_folder_tc'] = '#15ca20';
        ...
        $.ajax({
            ...
            type: "POST",
            url: `/store/operations/${menu_store_id}/meetings/add`,
            data: formData,
            contentType: false,
            processData: false,

...
<!--start page wrapper -->
		<div class="page-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-3">
                        @include('stores/procurement/pharmacy/drugOrderInvoices/partials/menu')
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-lg-12">
                                        ...
                                        {{-- @include('stores/procurement/pharmacy/drugOrderInvoices/partials/folders') --}}
                                    </div>
                                </div>
                                <div class="row ms-2 me-3">
                                    <div class="col-12 col-lg-12">
                                        @include('stores/procurement/pharmacy/drugOrderInvoices/partials/table')
                                    </div>
                                </div>
            ...
            @include('stores/procurement/pharmacy/drugOrderInvoices/modals/delete')
            @include('stores/procurement/pharmacy/drugOrderInvoices/modals/add')
            @include('stores/procurement/pharmacy/drugOrderInvoices/modals/edit-folder')
...
<style>
    ...
    .bg-all-files {
        border: solid 2px #f0bd9a !important;
    }
    .bg-all-files:hover {
        background-color: #fcd0b2 !important;
    }
    .text-all-files, .text-all-files:hover {
        background-color: #f0bd9a !important;
        color: #faec86 !important;  /*#81d995 !important;*/
    }
    .btn-success2 {
        background-color: #af5a20 !important;
        color: white !important;
    }
    .operations-submenu:hover {
        background-color: #fcd0b2 !important;
    }
...
<script>
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "/store/procurement/pharmacy/drug-order-invoice/data",
                type: "POST",
                headers: {
            ...
            columns: [
                { data: 'name', name: 'name', title: 'File',  orderable: false, searchable: false,
                    render: function(data, type, row) {
                        return `${row.file}`;
                    } 
                },
                // { data: 'page_name', name: 'page_name', title: 'Folder', orderable: false, searchable: false},
                { data: 'folder_name', name: 'folder_name', title: 'Date Created', orderable: false, searchable: false,
                    render: function(data, type, row) {

    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form name="delete_form"  id="delete_form"  >
                  <p>You are about to delete Reporting record. This procedure is irreversible. </p>
                  <p id="order_id_text" class="fw-bold"><p>
                  <input id="report_id" type="hidden" />
                  <p>This will delete the following:</p>
                  <ul>
                      <li>CMR Scores, TIPs scores and completion rates</li>
                  </ul>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" id="delete_btn" onclick="DeleteReport()">DELETE</button>
      </div>
    </div>
  </div>
</div>
...
<script>
  function ShowConfirmDeleteForm(id,date_reported) {
        $('#delete_form_modal').modal('show');
        $('#delete_form #report_id').val(id);
        $('#order_id_text').html('Report Data: '+date_reported);
  }
  ...
  function DeleteReport() {
                ...
                data.report_id = $('#delete_form #report_id').val();
            
                $.ajax({
                      headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                      type: "POST",
                      url: "/store/clinical/mtm-outcomes-reports/delete",
                      ...
                      success: function(msg) {
                        ...
                        $('#outcomes_table').DataTable().ajax.reload();
                      },error: function(msg) {

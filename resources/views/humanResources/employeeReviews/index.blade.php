...
<!--start page wrapper -->
		<div class="page-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-3">
                        @include('humanResources/employeeReviews/partials/menu')
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-lg-12">
                                        ...
                                        @include('humanResources/employeeReviews/partials/folders')
                                    </div>
                                </div>
                                <div class="row ms-2 me-3">
                                    <div class="col-12 col-lg-12">
                                        @include('humanResources/employeeReviews/partials/table')
                                    </div>
                                </div>
            ...
            @include('humanResources/employeeReviews/modals/delete')
            @include('humanResources/employeeReviews/modals/add')
            @include('humanResources/employeeReviews/modals/edit-folder')
...
<style>
    ...
    .text-success2 {
        color: #b834af !important;
    }

    .bg-all-files {
        border: solid 2px #ffe4fd !important;
    }
    .bg-all-files:hover {
        background-color: #f1c8f496 !important;
    }
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            columns: [
                ...
                // { data: 'formatted_created_at', name: 'formatted_created_at', title: 'Upload Date', orderable: false, searchable: false},

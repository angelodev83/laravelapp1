...
<!--start page wrapper -->
		<div class="page-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="announcement_table" class="table row-border hover" style="width:100%">
                                <thead></thead>
                                <tbody>                                   
                                </tbody>
                                <tfooter></tfooter>
            ...
            @include('humanResources/announcements/modal/add-announcement-form')
            @include('humanResources/announcements/modal/edit-announcement-form')
            @include('humanResources/announcements/modal/delete-announcement-form')
...
<script>
    ...
    $(document).ready(function() {
        ...
        const announcement_table = $('#announcement_table').DataTable({
            scrollX: true,
            serverSide: true,
            stateSave: false,
            dom: 'fBtip',
            ...
            searching: true,
            ajax: {
                url: "/admin/human_resources/announcements/data",
                type: "POST",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },

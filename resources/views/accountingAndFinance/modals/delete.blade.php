<div class="modal modal-md" style="display:none;" id="delete_document_form_modal" tabindex="-1">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              <form name="delete_form"  id="delete_form"  >
                    <p>You are about to remove a Financial Report document record. This procedure is irreversible. </p>
  ...
  <script>
      function ShowConfirmDeleteForm(id) {
        var btn = document.querySelector(`#btn-financial-report-delete-${id}`);
      ...
      function saveDelete() {
          ...
          $.ajax({
              ...
              type: "DELETE",
              url: "/admin/accounting-and-finance/documents/delete",

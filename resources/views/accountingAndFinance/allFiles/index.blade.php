...
<!--start page wrapper -->
		<div class="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3">
                    @include('accountingAndFinance/partials/menu')
                </div>
                ...
                <div class="col-12 col-lg-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @include('accountingAndFinance/allFiles/partials/folders')
                            ...
                            @include('accountingAndFinance/partials/table')
        ...
        @include('accountingAndFinance/modals/delete')
        @include('accountingAndFinance/modals/add')
@stop
...
let table_document;
    let folder_id;
    let page_id;
    let page_parent_id = {{request()->page_id}};

    $(document).ready(function() {
        page_parent_id = {{request()->page_id}};

        $('#financial-reports-lgi-all-files').addClass('selected');
    ...
    function loadDocuments() {
        ...
        const dt_table = $('#dt_table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: `/admin/accounting-and-finance/documents/${page_parent_id}/data`,
                type: "POST",
                headers: {
                ...
                data: function (data) {
                    ...
                    data.page_parent_id = page_parent_id;
                },
                error: function (msg) {
    ...
    function clickPageFolder(selected_page_id, _id) {
        ...
        $('.knowledge-base-all-folder-card').removeClass('knowledge-base-sea-folder-card-selected');
        $('.knowledge-base-all-folder-card').removeClass('knowledge-base-cf-folder-card-selected');
        $('.knowledge-base-all-folder-card').removeClass('knowledge-base-xpl-folder-card-selected');
        $('.knowledge-base-all-folder-card').removeClass('knowledge-base-pp-folder-card-selected');

(function ($, window, document, undefined) {
  ...
  $.fn.imageuploadify = function (opts) {
    ...
    this.each(function () {
      ...
      let totalFiles = [];
      let counter = 0;
      let filecaption = "Drag&Drop Your File(s) Here To Upload";
      if (isSingle) {
        filecaption = "Drag&Drop a Single File Only";
      }
      let dragbox = $(
        `<div class="imageuploadify well px-3"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i><span class='imageuploadify-message'>${filecaption}</span><button type="button"class="btn btn-default">or select file to upload</button></div></div>`
      );
      ...
      const retrieveFiles = (files) => {
        let filesLen = isSingle === true ? 1 : files.length;
      ...
      dragbox.on("drop", function onDrop(event) {
        ...
        $(".imageuploadify-file-general-class")[0].files = files;
        retrieveFiles(files);
      });

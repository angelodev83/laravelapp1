...
class ClinicalPendingRefillRequestMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $emailSubject = 'Pending refill requests for '.$date;
        $createdBy = '';
        $user = auth()->user();
        ...
        return $this->view('emails.clinical_pending_refill_requests')

...
class TebraPatientController extends Controller
{
    public function index($id, Request $request)
    {
        try {
            ...
            return view('/stores/clinical/tebra/index', compact('breadCrumb'));
        } catch (\Throwable $th) {
    ...
    public function facesheet($id, $p_id)
    {
        ...
        return view('/stores/clinical/tebra/patientData', compact('user','breadCrumb', 'profileData'));
    }
    ...
    public function get_immunizations($id, $p_id)
    {
        ...
        return view('/stores/clinical/tebra/patientImmunizations', compact('user','breadCrumb', 'id'));
    }
    ...
    public function get_notes($id, $p_id)
    {
        ...
        return view('/stores/clinical/tebra/patientNotes', compact('user','breadCrumb', 'id'));
    }
            ...
            foreach ($data as $value) {
                ...
                $newData[] = [
                    ...
                    'actions' =>  '<div class="d-flex order-actions">
                        ...
                        <a href="/store/clinical/tebra-patients/note_download/'.$value->file_id.'"
    ...
    public function get_demographics($id, $p_id)
    {
        ...
        return view('/stores/clinical/tebra/patientDemographics', compact('user','breadCrumb', 'id'));
    }
    ...
    public function get_allergies($id, $p_id)
    {
        ...
        return view('/stores/clinical/tebra/patientAllergies', compact('user','breadCrumb', 'id'));
    }
    ...
    public function get_medications($id, $p_id)
    {
        ...
        return view('/stores/clinical/tebra/patientMedications', compact('user','breadCrumb', 'id'));
    }

    public function get_patient_medications_data(Request $request, $store_id)
    {   
        if($request->ajax()){
            // Page Length
            $pageNumber = ( $request->start / $request->length )+1;
            ...
            $id = $request->patient_id;
            // get data from products table
            $query = PatientMedication::where('pharmacy_store_id', $store_id)
                // ->where('patient_id', $id)
            ...
            if ($validation->passes()){
                ...
                for ($i = 0; $i <= $input['med_count']; $i++) {
                    if (!empty($request->input("drugname$i")&&$request->input("quantity$i")&&$request->input("store_location$i"))) {
                        ...
                        $med->pharmacy_store_id = $input['pharmacy_store_id'];

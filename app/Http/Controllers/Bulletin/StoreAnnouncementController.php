...
class StoreAnnouncementController extends Controller
{
    ...
    )
    {
        ...
        $this->middleware('permission:menu_store.bulletin.announcements.index|menu_store.bulletin.announcements.create|menu_store.bulletin.announcements.update|menu_store.bulletin.announcements.delete');
    }
    ...
    public function index($id)
    {
        try {
            ...
            return view('/stores/bulletin/announcements/index', compact('breadCrumb'));
        } catch (\Throwable $th) {
